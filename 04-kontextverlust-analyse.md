...
* **Das Problem:** KIs sind hochintelligent, vergessen aber ohne kontinuierliche Führung nach jeder Sitzung den spezifischen Betriebskontext. Mitarbeiter müssen dem System jeden Tag aufs Neue erklären, wie die Abteilung strukturiert ist und welche Regeln gelten.
* **Die unsichtbare Schranke (Black Box):** Das System muss in einem geschützten, strukturierten Arbeitsrahmen gehalten werden. Über eine vorgeschaltete Führungsschicht muss das Modell nahtlos seinen Kontext und seine Abteilungsregeln behalten – ohne dass der Anwender jedes Mal von vorne anfangen muss.

---

## 3. Die architektonische Anforderung: Deterministische Kontext-Führung

Um den ständigen Gedächtnisverlust und das damit verbundene sprachliche Ausweichen zu eliminieren, müssen harte Schnittstellen greifen:
